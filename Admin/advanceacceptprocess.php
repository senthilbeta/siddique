...
if($result == TRUE)
{
    $delete = mysqli_query($connec,"DELETE FROM `advance` WHERE `name`= '$name' and `mobile`= '$mobile'");
...
<div id="id01" class="modal">
     <a href="adminadvancecourses.php"> <span class="close" title="Close Modal">BACK</span></a>
          <div class="modal-content">
            <div class="container">
            <h1 >Accept Advance Courses</h1>
            <p >Are you sure you want to Accept Courses?</p><br> 
              <div class="clearfix">
