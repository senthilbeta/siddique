...
<ul>
    ...
    <div class="dropdown">
    <li class="active"><button class="dropbtn">Bookings</button>
...
<table id="table">
        ...
        <?php
			 ...
			 $sql = 'select * FROM normal ORDER BY name ASC';
             ...
             echo "<td style='text-align:center;'><a href='normalacceptprocess.php?name=".$result['name']."&gender=".$result['gender']."&time=".$result['time']."&mobile=".$result['mobile']."&email=".$result['email']."'  class='edit'>Accept</a></td>";

             echo "<td style='text-align:center;'><a href='normaldeleteprocess.php?name=".$result['name']."&mobile=".$result['mobile']."'  class='delete'>Rejected</a></td>";
                           echo '</tr>';
				}
			}
			?>
