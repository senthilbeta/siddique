...
if(isset($_POST['d1'])){
        $name = $_GET['name'];
        $no = $_GET['mobile'];
        $delete = mysqli_query($connec,"DELETE FROM `advance` WHERE `name`= '$name' and `mobile`= '$no'");
        
    } 

if($delete == TRUE) {
        header('Location: adminadvancecourses.php');
...
<div id="id01" class="modal">
     <a href="adminadvancecourses.php"> <span class="close" title="Close Modal">BACK</span></a>
          <div class="modal-content">
            <div class="container">
            <h1 >Reject Account</h1>
            <p >Are you sure you want to Reject account?</p><br> 
              <div class="clearfix">
              <form  method="post" onsubmit="submitForm()">
	       <a href="adminadvancecourses.php" type="button"  class="cancelbtn" name="cancle">Cancel</a>
