...
if(isset($_POST['d1'])){
        $name = $_GET['name'];
        $no = $_GET['mobile'];
        $delete = mysqli_query($connec,"DELETE FROM `normalbooking` WHERE `name`= '$name' and `mobile`= '$no'");
...
<div id="id01" class="modal">
     <a href="adminusers.php"> <span class="close" title="Close Modal">BACK</span></a>
          <div class="modal-content">
	       ...
	       <a href="adminusers.php" type="button"  class="cancelbtn" name="cancle">Cancel</a>
