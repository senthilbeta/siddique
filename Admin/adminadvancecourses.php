...
<ul>
    ...
    <li><button class="dropbtn">Bookings</button>
        <div class="dropdown-content">
          ...
          <a href="adminadvancecourses.php"class="active">Advancedcourses</a>
        </div>
      </div></li>
      <div class="dropdown2">
...
<table id="table">
        ...
        <?php
             ...
             echo "<td><a href='advanceacceptprocess.php?name=".$result['name']."&gender=".$result['gender']."&time=".$result['time']."&mobile=".$result['mobile']."&email=".$result['email']."'  class='edit'>Accepted</a></td>";

             echo "<td><a href='advancedeleteprocess.php?name=".$result['name']."&mobile=".$result['mobile']."'  class='delete'>Rejected</a></td>";
                           echo '</tr>';
				}
			}
			?>
