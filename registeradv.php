...
<body>
  ...
  <ul>
    ...
    <input type="text"placeholder="Enter your name" required style="margin-left: 23px;padding: 5px 3px;"><br>
      <label for="" class="jm">Gender:</label>
       <select name="" id=""style="margin-left: 14px; padding: 6px 40px;"><option value="" >Male</option><option value="">Female</option></select><br>
   
    <label for="" class="jm" >Timing:</label><select name="" id="" aria-placeholder="Select" required style="margin-left: 5%; padding: 6px 40px;">
       
        <option value="" >7:00am-9:00am</option>
        <option value="">2:00pm-4:00pm</option>
        <option value="">5:00pm-7:00pm</option>

    </select> <br>
    <br>
    <label for="">Mobile:</label> <input type="number" placeholder="Enter mobile number" required style="margin-left: 10px;padding: 5px 1px;"><br><br> <br>
    ...
    <label for="">Email:</label><input type="email" placeholder="Enter your email" required style="margin-left: 25px;padding: 5px 5px;"><br><br>
<input type="submit" value="Register"style="margin-left: 20%; margin-top: 2%;font-size: medium; font-family: monospace; height: 35px; width: 20%; border-radius: 8px; font-size: 14px; 
font-family: cursive;font-weight: bold;border: none; "></form>
